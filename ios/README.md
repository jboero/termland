...
This is the native SwiftUI control-plane client: saved direct TCP/TLS profiles,
Keychain passwords, and a live resumable-session list. It deliberately does
not stream or render sessions yet; VideoToolbox, input, and audio are M3c+.
...
Xcode to use a signed simulator or device destination.
